...
class Matrix {
    ...
    public:
        ...
        /**
         * The move-constructor. Moves the contents of m into the new object
         * being initialized.
         * @param an instance of Matrix
         * @return instance of Matrix with the elements from m moved into it
         */
         Matrix(Matrix &&m);

        /**
         * (the move-assignment operator) moves the contents of m into the LHS
         * of the assignment.
         * @param an instance of Matrix
        ...
        /**
         * compound addition assignment operator for Matrix
        ...
        /**
         * compound subtraction assignment operator for Matrix
         * @param Matrix instance
         * @return Matrix instance
         */
        Matrix &operator-=(const Matrix &m);
        ...
        /**
         * compound multiplication assignment operator for Matrix
         * @param Matrix instance
         * @return Matrix instance
         */
        Matrix &operator*=(const Matrix &m);
...
/**
 * simple addition operator for Matrices
 * @param Matrix instance
 * @param Matrix instance
 * @return Matrix instance
 */
...
/**
 * simple subtraction operator for Matrices
 * @param Matrix instance
 * @param Matrix instance
 * @return Matrix instance
 */
...
/**
 * simple multiplication operator for Matrices
 * @param Matrix instance
 * @param Matrix instance
 * @return Matrix instance
 */
